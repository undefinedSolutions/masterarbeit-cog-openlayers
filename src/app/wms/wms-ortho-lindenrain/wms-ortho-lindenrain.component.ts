...
@Component({
  selector: 'app-wms-ortho-lindenrain',
  templateUrl: './wms-ortho-lindenrain.component.html',
  styleUrls: ['./wms-ortho-lindenrain.component.scss']
})
export class WmsOrthoLindenrainComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    const WMS = new ImageLayer({
      ...
      source: new ImageWMS({
        ...
        params: {'LAYERS': '	wms:ortho_lindenrain'},
        ratio: 1,
