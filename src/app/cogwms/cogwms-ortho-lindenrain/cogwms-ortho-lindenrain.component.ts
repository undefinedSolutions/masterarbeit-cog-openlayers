...
@Component({
  selector: 'app-cogwms-ortho-lindenrain',
  templateUrl: './cogwms-ortho-lindenrain.component.html',
  styleUrls: ['./cogwms-ortho-lindenrain.component.scss']
})
export class CogwmsOrthoLindenrainComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    const WMS = new ImageLayer({
      ...
      source: new ImageWMS({
        ...
        params: {'LAYERS': '	cog-wms:ortho_lindenrain'},
        ratio: 1,
