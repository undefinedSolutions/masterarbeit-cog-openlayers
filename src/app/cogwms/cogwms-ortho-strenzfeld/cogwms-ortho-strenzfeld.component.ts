...
@Component({
  selector: 'app-cogwms-ortho-strenzfeld',
  templateUrl: './cogwms-ortho-strenzfeld.component.html',
  styleUrls: ['./cogwms-ortho-strenzfeld.component.scss']
})
export class CogwmsOrthoStrenzfeldComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    const WMS = new ImageLayer({
      ...
      source: new ImageWMS({
        ...
        params: {'LAYERS': '	cog-wms:ortho_strenzfeld'},
        ratio: 1,
