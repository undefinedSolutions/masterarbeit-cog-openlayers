...
@Component({
  selector: 'app-cogwms-dsm-strenzfeld',
  templateUrl: './cogwms-dsm-strenzfeld.component.html',
  styleUrls: ['./cogwms-dsm-strenzfeld.component.scss']
})
export class CogwmsDsmStrenzfeldComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    const WMS = new ImageLayer({
      ...
      source: new ImageWMS({
        ...
        params: {'LAYERS': '	cog-wms:dsm_strenzfeld'},
        ratio: 1,
