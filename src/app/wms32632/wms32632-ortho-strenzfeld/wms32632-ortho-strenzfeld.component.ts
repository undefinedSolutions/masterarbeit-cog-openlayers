...
@Component({
  selector: 'app-wms32632-ortho-strenzfeld',
  templateUrl: './wms32632-ortho-strenzfeld.component.html',
  styleUrls: ['./wms32632-ortho-strenzfeld.component.scss']
})
export class Wms32632OrthoStrenzfeldComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    const WMS = new ImageLayer({
      ...
      source: new ImageWMS({
        ...
        params: {'LAYERS': '	wms-32632:ortho_strenzfeld'},
        ratio: 1,
