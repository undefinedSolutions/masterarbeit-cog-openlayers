...
@Component({
  selector: 'app-wmts-ortho-lindenrain',
  templateUrl: './wmts-ortho-lindenrain.component.html',
  styleUrls: ['./wmts-ortho-lindenrain.component.scss']
})
export class WmtsOrthoLindenrainComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    const resolutions = new Array(AoiLindenrain.ortho.max + 1);
    const matrixIds = new Array(AoiLindenrain.ortho.max + 1);
    for (let z = 0; z < AoiLindenrain.ortho.max + 1; ++z) {
