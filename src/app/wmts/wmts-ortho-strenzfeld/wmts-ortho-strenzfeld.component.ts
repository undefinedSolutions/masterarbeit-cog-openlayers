...
@Component({
  selector: 'app-wmts-ortho-strenzfeld',
  templateUrl: './wmts-ortho-strenzfeld.component.html',
  styleUrls: ['./wmts-ortho-strenzfeld.component.scss']
})
export class WmtsOrthoStrenzfeldComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    const resolutions = new Array(AoiStrenzfeld.ortho.max + 1);
    const matrixIds = new Array(AoiStrenzfeld.ortho.max + 1);
    for (let z = 0; z < AoiStrenzfeld.ortho.max + 1; ++z) {
